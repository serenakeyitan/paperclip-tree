...
This node covers the inbox frontend UX. The underlying task and comment data model is in [product/task-system](../../product/task-system/NODE.md). The inbox is a view, not a separate data model.
