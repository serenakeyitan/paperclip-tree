...
The MCP server is a separate entry point in the monorepo, not embedded in the main Express backend. This allows it to be run independently or bundled for distribution to MCP hosts.
