...
The issue list and inbox share filtering and display patterns but serve different purposes: the issue list is a team-scoped view of all work, while the inbox is a personal view of items requiring the viewer's attention. Polish in PR #3356 aligned their interaction patterns so users build one mental model for navigating work items.
