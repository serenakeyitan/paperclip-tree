...
See `adapters/NODE.md` for the adapter interface contract and other local adapters (Claude, Codex, Cursor, Gemini, OpenCode, Pi) which use the shared `command` field convention.
