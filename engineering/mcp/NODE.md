---
title: "MCP Server"
owners: [bingran-you, cryppadotta, serenakeyitan, davison]
---

# MCP Server

Model Context Protocol (MCP) server that exposes Paperclip capabilities as tools for external AI agents and clients. Source: MCP server package within the monorepo.
...
The MCP server is a protocol adapter — it translates MCP tool calls into Paperclip service calls. Business logic lives in the backend services, not in the MCP layer.
