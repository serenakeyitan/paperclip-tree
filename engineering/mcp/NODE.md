---
title: "MCP Server"
owners: [bingran-you, cryppadotta, serenakeyitan, nya1]
---
...
The MCP server manifest is included in the Docker dependency stage to ensure the MCP server is available in containerized deployments without requiring a separate build step.

## Boundaries

Business logic lives in backend services, not in the MCP layer. The MCP server only handles protocol translation and request validation.
