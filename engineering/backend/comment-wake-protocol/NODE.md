...
soft_links: ["engineering/backend/heartbeat-run-orchestration/NODE.md", "product/task-system/NODE.md"]
---
...
- The heartbeat protocol (scheduled wakes) is defined in the agent model. This node covers comment-triggered wakes specifically.
