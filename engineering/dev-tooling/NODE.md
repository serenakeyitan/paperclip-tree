...
### Worktree-first development model

Both human developers and AI agents use worktrees for isolated work. This unifies the development model rather than having separate workflows for human and agent contributors.

### CLI as the primary dev tool surface

Developer tooling is exposed through the `paperclipai` CLI rather than separate scripts, keeping the tool surface unified and discoverable.

### Contributor documentation lives in-repo

Onboarding guides, setup instructions, and contribution workflows are maintained alongside the code they describe, not in external wikis. Documentation updates are tracked as engineering tasks and reviewed with the same rigor as code changes.
