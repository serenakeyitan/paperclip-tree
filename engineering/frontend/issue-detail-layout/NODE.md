...
soft_links: ["engineering/frontend/issue-thread-ux"]
---

# Issue Detail Layout

Layout and rendering patterns for the issue detail view — the primary surface for viewing and editing a single issue. Distinct from issue thread UX (discussion rendering) and inbox list (task triage).
...
Document diffs are rendered inline within the issue detail view rather than delegated to a separate diff component.
