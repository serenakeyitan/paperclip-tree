...
Parent issue and time-ago columns use narrow, fixed widths to maximize horizontal space for issue titles. These columns show abbreviated content (truncated parent title, relative time) to keep the list scannable.
