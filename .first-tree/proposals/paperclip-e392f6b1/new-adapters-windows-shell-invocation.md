...
target_node: new
rationale: Local adapters must use cmd.exe to invoke .cmd/.bat files on Windows; this cross-cutting platform constraint affects all local adapters but is not documented anywhere in the tree.
---
