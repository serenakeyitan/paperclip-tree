...
target_node: new
rationale: The inbox is mentioned only as a one-liner in the frontend and task-system nodes — this PR adds search with comment-matching fallback and filter-aware refetch optimization, none of which are captured.
---
# Inbox
