...
target_node: new
rationale: The existing execution-workspaces node describes lock acquisition (scoped checkout) but not stale lock detection, expiry, or recovery — which is the core concern of this PR (PIP-002).
---
