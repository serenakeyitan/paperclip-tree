...
target_node: new
rationale: Inbox issue search with comment matching, fallback strategy, and filter-only refetch avoidance are new features not covered by any existing task-system or frontend node (PR #3385).
---
# Inbox Issue Search
