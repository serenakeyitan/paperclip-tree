...
target_node: new
rationale: The codex-local adapter node documents capabilities but has no mention of fast mode — a new execution flag that must be disabled during env probing.
---
# Codex Fast Mode
