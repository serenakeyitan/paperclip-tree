...
target_node: new
rationale: The PR's 'no hardcoded JWT secret fallback' security decision exists only in drift/paperclip-e392f6b1/infrastructure/security/NODE.md — no infrastructure/security node exists in the main tree to capture security hardening conventions.
---
