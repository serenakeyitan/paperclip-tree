...
target_node: new
rationale: Security conventions node exists only in drift — the PR's security docs improvements suggest this should be promoted to a permanent tree node under infrastructure/.
---
# Security
