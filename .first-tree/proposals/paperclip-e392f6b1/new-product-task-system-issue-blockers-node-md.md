...
target_node: new
rationale: The PR introduces first-class blocking/blocked-by relationships between issues with automatic dependency wakeups — resolving an open question in the task-system node that had no prior coverage.
---
