...
target_node: new
rationale: The PR introduces live update infrastructure for issue workflow surfaces; no existing node documents real-time update patterns (SSE, WebSocket, polling, or optimistic update strategies).
---
# Live Updates
...
**Rationale:** Autonomous agents move fast — an issue can transition through multiple states in seconds. Stale UI creates confusion for human board operators who need accurate visibility to exercise governance.
