...
target_node: new
rationale: Existing issue-thread-ux nodes cover rendering and routing but not performance optimization for long threads — this PR introduces a performance fix pattern for typing lag in long comment threads that future thread work needs to know about.
---
# Thread Performance
