...
target_node: new
rationale: PR adds configurable show/hide columns to the inbox grid (including a Parent Issue column) and narrows column widths — the existing inbox list node only covers filter/refetch behavior, not column configuration.
---
