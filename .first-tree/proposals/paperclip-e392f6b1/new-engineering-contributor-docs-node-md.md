...
target_node: new
rationale: PR explicitly refreshes contributor documentation; the tree has no node capturing contributor onboarding, contribution guidelines, or documentation conventions — these cross-cut engineering, infrastructure, and adapters.
---
---
