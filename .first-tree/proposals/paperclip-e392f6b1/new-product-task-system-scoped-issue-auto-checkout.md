...
target_node: new
rationale: Auto-checkout of scoped issue branches when agents wake in the harness is a new orchestration behavior not captured in any existing node — the task system mentions atomic checkout but not automatic branch checkout on wake.
---
