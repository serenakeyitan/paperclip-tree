...
target_node: new
rationale: The existing task-system node does not cover search behavior — the PR introduces relevance-ranked multi-field search with performance-first async rendering.
---
# Issue Search
