...
target_node: new
rationale: The frontend node documents React Query for server state but has no node covering the real-time/live update pattern introduced by this PR for keeping issue workflow surfaces synchronized with backend state.
---
# Live Updates
