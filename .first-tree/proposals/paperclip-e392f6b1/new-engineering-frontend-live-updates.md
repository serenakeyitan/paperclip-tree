...
target_node: new
rationale: The frontend node documents React Query for server state but has no node covering real-time/live update patterns (SSE, WebSocket, polling, or optimistic update strategies) introduced in this PR.
---
## Live Updates
