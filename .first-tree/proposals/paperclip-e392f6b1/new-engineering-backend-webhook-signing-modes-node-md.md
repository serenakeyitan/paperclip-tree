...
target_node: new
rationale: The PR introduces multiple webhook signing/verification modes (github_hmac, none) — a server security decision with no tree coverage; the backend NODE.md has no mention of webhooks or their verification.
---
