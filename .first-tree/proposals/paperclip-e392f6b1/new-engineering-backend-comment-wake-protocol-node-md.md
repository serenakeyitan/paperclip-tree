...
target_node: new
rationale: The PR introduces comment-triggered agent wakes with debouncing and deduplication — a distinct wake mechanism from the heartbeat run orchestration already documented.
---
